...
1. If $$\beta := \ovl{\lim}\bigg| \frac{a_{n+1}}{a_{n}} \bigg|< 1$$ then $\sum a_{n}$ converges.
2. If $\exists n_{0}$ such that $$\bigg| \frac{a_{n+1}}{a_{n}} \bigg| \geq 1$$, $\forall n \geq n_{0}$ then $\sum a_{n}$ diverges. 
